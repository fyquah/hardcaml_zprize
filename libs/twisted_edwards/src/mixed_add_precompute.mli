(** Fully/Half pipelined mixed addition for {{:https://en.wikipedia.org/wiki/Twisted_Edwards_curve} twisted edwards curve} curve with [a = -1], optimized with precomputation.
    ...
    affine point being streamed into the host via FPGA.
    ...
    The running sum in the FPGA, usually represented in terms
    ...
    {[
      let add_unified_with_precompute running_sum x_host =
