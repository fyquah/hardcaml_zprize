(** Bindings to the g1 modulue in the ark-bls12-381 rust package. This is used
...
(** Returns true if the point is on the eliptic bls12-381 curve. Note that for
...
(** Returns the bls12-381 subgroup generator. *)
