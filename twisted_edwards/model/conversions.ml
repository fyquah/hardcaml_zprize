...
let montgomery_params_to_twisted_edwards_params ({ c_A; c_B = _; twisted_scale } : Montgomery_curve.params)
...
let twisted_edwards_params_to_montgomery_params ({ a = _; d; twisted_scale } : Twisted_edwards_curve.params)
...
let weierstrass_affine_to_twisted_edwards_affine weierstrass_params point =
  ...
  montgomery_affine_to_twisted_edwards_affine montgomery_params
