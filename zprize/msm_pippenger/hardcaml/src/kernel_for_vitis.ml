...
module Make (Config : Config.S) = struct
  ...
  let create
    ...
    let host_scalars_to_fpga_registers = Axi512.Stream.Register.O.Of_signal.wires () in
    ...
    Axi512.Stream.Register.O.Of_signal.( <== )
      ...
      (axis_pipeline_512
         ...
         { clock
         ; clear
         ; up = host_scalars_to_fpga
         ; dn_dest = merge_axi_streams__host_scalars_to_fpga_dest
         });
    Axi512.Stream.Register.O.Of_signal.( <== )
    ...
    let merge_axi_streams =
      Merge_axi_streams.hierarchical
        ...
        { clock
        ; clear
        ; host_scalars_to_fpga = host_scalars_to_fpga_registers.dn
